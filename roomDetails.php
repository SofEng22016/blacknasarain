        ...
        <div class="row">
			...
			<?php 
				if(isset($_GET['page'])){
					...
					echo " <li><a data-toggle='tab' href='#cancelled'>Cancelled Reservations</a></li>";
					echo "<div class='tab-content'>";
					echo "<div id='approved' class='tab-pane fade in active'>";
					if($total != null){
						include 'viewApprovedRooms.php';
					} else {
						echo "<h4 class='alert alert-info' align='center'>There are no approved reservations at the moment.</h4>";
					}
					echo "</div>";
					...
					if($total1 != null){
						...
						echo "<h4 class='alert alert-info' align='center'>There are no denied reservations at the moment.</h4>";
					}
					echo "</div>";
					echo "<div id='cancelled' class='tab-pane fade'>";
					if($total4 != null){
						include 'viewCancelledRooms.php';
					} else {
						echo "<h4 class='alert alert-info' align='center'>There are no cancelled reservations at the moment.</h4>";
					}
					echo "</div>";
					echo "</div>";
					...
					echo "<li><a data-toggle='tab' href='#approved'>Approved Room Reservations</a></li>";
					echo "<li><a data-toggle='tab' href='#denied'>Denied Room Reservations</a></li>";
					echo " <li class='active'><a data-toggle='tab' href='#cancelled'>Cancelled Reservations</a></li>";
					echo "<div class='tab-content'>";
					echo "<div id='approved' class='tab-pane fade'>";
					if($total != null){
						include 'viewApprovedRooms.php';
					...
					echo "</div>";
					echo "<div id='cancelled' class='tab-pane fade in active'>";
					if($total4 != null){
						include 'viewCancelledRooms.php';
					} else {
						echo "<h4 class='alert alert-info' align='center'>There are no cancelled reservations at the moment.</h4>";
