        ...
        <div class="row">
			...
			?>
        		<?php   
				   ...
				   $sql = "SELECT * FROM equipment_approved_db WHERE return_status ='For Verification'";
				   $result = $conn->query($sql);
				   
				   if ($result->num_rows > 0) {
				   	echo "<br><form action='verificationHandler.php' method='post' align='center'>";
					...
					echo "</tr>";
				   	...
				   	echo "</table><br><input type='button' class='btn btn-success' data-toggle='modal' data-target='#confirmationModalA' value='Verify'/>";
				   } else {
				   	echo "<br><div class='alert alert-info'>"."<center>There are currently no pending equipment returns to verify.</center>"."</div>"; //proper message here pls.
				   }
			    ...
			    <div class="modal-dialog">
			      <div class="modal-content">
			        ...
			        <div class="modal-footer">
			           <input type='submit' name='choice' class='btn btn-success' value='Verify'/><button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
			        </div>
			      </div>
			    </div>
			  </div>
